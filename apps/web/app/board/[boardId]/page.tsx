...
const customShapeUtils = [StickyNoteShapeUtil, FeatureCardShapeUtil, RiskFlagShapeUtil, CommentShapeUtil, PRDCardShapeUtil, SpecCardShapeUtil, TaskListShapeUtil];
