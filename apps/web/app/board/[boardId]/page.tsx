...
const customShapeUtils = [StickyNoteShapeUtil, FeatureCardShapeUtil, RiskFlagShapeUtil, AlertCardShapeUtil, CommentShapeUtil, PRDCardShapeUtil, SpecCardShapeUtil, TaskListShapeUtil];
